...
public sealed class CreateCarCommandValidator : AbstractValidator<CreateCarCommand>
{
    public CreateCarCommandValidator()
    {
        ...
        RuleFor(p => p.Model).NotEmpty().WithMessage("Araç modeli boş bırakılamaz!");
        RuleFor(p => p.Model).NotNull().WithMessage("Araç modeli boş bırakılamaz!");
        ...
        RuleFor(p => p.EnginePower).GreaterThan(0).WithMessage("Araç motor gücü boş olamaz!");
